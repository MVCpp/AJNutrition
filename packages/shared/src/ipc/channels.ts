...
export const IPC_CHANNELS = {
  ...
  recipeUpdate: 'ajn:recipe:update',
  ...
  consultationUpdate: 'ajn:consultation:update',
  appointmentCreate: 'ajn:appointment:create',
  appointmentReschedule: 'ajn:appointment:reschedule',
  appointmentResolve: 'ajn:appointment:resolve',
