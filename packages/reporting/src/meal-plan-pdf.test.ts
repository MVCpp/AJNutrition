  ...
  dayPlans: [
    {
      ...
      meals: [
        ...
        { slot: 'snack1', items: [], totals: enriched({ energy_kcal: 0 }), targetKcal: null },
        { slot: 'lunch', items: [], totals: enriched({ energy_kcal: 0 }), targetKcal: null },
        { slot: 'snack2', items: [], totals: enriched({ energy_kcal: 0 }), targetKcal: null },
