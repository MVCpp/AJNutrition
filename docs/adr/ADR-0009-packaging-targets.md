...
- **Windows:** Squirrel installer (`NutriPlan-Setup.exe`) + ZIP. Per-user install, no admin rights, delta-update capable. Revisit vs WiX/MSI only if enterprise/machine-wide deployment appears.
